...
public class ViewHoliday extends BaseServlet {
	
	private static final Logger log = Logger.getLogger(ViewHoliday.class);

	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
	}

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		log.debug(ViewHoliday.class);
		String regionSelected = request.getParameter("cri_region");
		log.debug("ViewHoliday region selected = " + regionSelected);
